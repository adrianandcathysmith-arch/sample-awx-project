pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-04-890a47241d0b"
        TF_VAR_bucket = "tf-remote-state-student_04_0eaf8297f7fe-18961-30557"
        REPOSITORY = "https://github.com/adrianandcathysmith-arch/sample-awx-project"
